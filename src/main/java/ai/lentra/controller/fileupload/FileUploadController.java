package ai.lentra.controller.fileupload;
...
FileUploadServiceImpl fileUploadServiceImpl;
    ...
    @GetMapping(value = "/files/{applicantId}/download/{fileName}", produces = {MediaType.APPLICATION_JSON_VALUE,MediaType.IMAGE_JPEG_VALUE, MediaType.IMAGE_PNG_VALUE,MediaType.IMAGE_GIF_VALUE,MediaType.IMAGE_GIF_VALUE,"image/bmp","image/tiff"})
