...
@Entity
@Table(name = "h_verifiers")
public class VerifierHistory {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private long verifierHistoryId;
    private String fiId;
    private String comKey;

    public long getVerifierHistoryId() {
        return verifierHistoryId;
    }

    public void setVerifierHistoryId(long verifierHistoryId) {
        this.verifierHistoryId = verifierHistoryId;
    }
